...
#    # SHAPE = hf.helperfunctions.EnumGenGridPositionsShapes
...
#                                                                 'diagonal_sw',
#                                                                ]
#        SHAPES = hf.helperfunctions.EnumGenGridPositionsShapes()
#        self.assertListEqual([shape for shape in SHAPES], known_answers_Enum_gen_grid_positions_shapes_in_order)
